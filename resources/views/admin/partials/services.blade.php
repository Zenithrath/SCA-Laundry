            ...
            <div
                ...
                <div class="flex-1 min-w-0 w-full">
                    <input
                        ...
                        class="w-full font-bold text-lg bg-transparent border-b border-transparent focus:border-blue-500 outline-none">
                ...
                <div class="w-full sm:w-auto flex flex-col gap-2 sm:items-end">
                    <div class="flex items-center gap-2 w-full sm:w-auto">
                        ...
                        <input
                            ...
                            class="w-full sm:w-24 p-2 rounded-lg text-right font-bold text-sm
